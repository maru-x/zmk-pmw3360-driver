...
/* Timings (in us) used in SPI communication. Since MCU should not do other
 * tasks during wait, k_busy_wait is used instead of k_sleep */
...
#define PMW3360_CPI_DIVIDOR 1
#define PMW3360_SNIPE_CPI_DIVIDOR 1

#define PMW3610_REPORT_INTERVAL_MIN 0
